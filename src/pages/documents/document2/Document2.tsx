...
import Document2View from "./Document2.view";

export const Document2: FunctionComponent = (props: any) => {
	...
	return Document2View({ formSearch, listData, paging, getData, handleSubmit, handleOpenDialog, handleCloseDialog, setPaging });
};
